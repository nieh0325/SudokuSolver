        ...
        for c in res:
            ...
            if slot_l < cx < slot_r:
                ...
                if best is None or score > best[3]*best[2]*best[6]:
                    best = c
        if best:
            print(f'  Slot {slot+1}: w={best[2]} h={best[3]} area={best[3]*best[2]} type={best[7]}')
        else:
